...
<title>IDEA HOMES | BOOKMARK PROPERTIES </title>
            ...
            <ul class="nav navbar-nav" data-in="fadeInDown" data-out="fadeOutUp">
              ...
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="bookmark-properties.html">Bookmark Properties</a></li>
...
<section class="my_pro padding bg-color-gray">
  <div class="container">
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="text-uppercase">Bookmark <span class="color_red"> Properties</span></h2>
    ...
    <div class="row">
      <div class="property-list-list" data-target="Residential">
        <div class="col-xs-12 col-sm-4 col-md-4 property-list-list-image">
          <img src="images/recent-property-1.png" alt="recent-properties-1" class="img-responsive">
        </div>
        <div class="col-xs-12 col-sm-8 col-md-8 property-list-list-info">
          ...
          <div class="col-xs-12 col-sm-6 col-md-6">
            <label class="property-list-list-label">On Sale</label>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-6">
            <p class="recent-properties-price">New York City / Brooklyn</p>
            <span class="recent-properties-address">$530,600</span>
            <p>Lorem ipsum dolor sit amet, consecteturin ligula convallis vel tincidunt ipsum posu sollicitudin.</p>
          </div>
      ...
      <div class="property-list-list" data-target="Residential">
        <div class="col-xs-12 col-sm-4 col-md-4 property-list-list-image">
          <img src="images/recent-property-2.png" alt="recent-properties-1" class="img-responsive">
        </div>
        <div class="col-xs-12 col-sm-8 col-md-8 property-list-list-info">
          <div class="col-xs-12 col-sm-6 col-md-6">
            <a href="#.">
      ...
      <div class="property-list-list" data-target="Residential">
        <div class="col-xs-12 col-sm-4 col-md-4 property-list-list-image">
          <img src="images/recent-property-3.png" alt="recent-properties-1" class="img-responsive">
        </div>
        <div class="col-xs-12 col-sm-8 col-md-8 property-list-list-info">
          <div class="col-xs-12 col-sm-6 col-md-6">
            <a href="#.">
      ...
      <div class="property-list-list" data-target="Residential">
        <div class="col-xs-12 col-sm-4 col-md-4 property-list-list-image">
          <img src="images/recent-property-4.png" alt="recent-properties-1" class="img-responsive">
        </div>
        <div class="col-xs-12 col-sm-8 col-md-8 property-list-list-info">
          <div class="col-xs-12 col-sm-6 col-md-6">
            <a href="#.">
      ...
      <div class="property-list-list" data-target="Residential">
        <div class="col-xs-12 col-sm-4 col-md-4 property-list-list-image">
          <img src="images/recent-property-5.png" alt="recent-properties-1" class="img-responsive">
        </div>
        <div class="col-xs-12 col-sm-8 col-md-8 property-list-list-info">
          <div class="col-xs-12 col-sm-6 col-md-6">
            <a href="#.">
      ...
      <div class="property-list-list" data-target="Residential">
        <div class="col-xs-12 col-sm-4 col-md-4 property-list-list-image">
          <img src="images/recent-property-6.png" alt="recent-properties-1" class="img-responsive">
        </div>
        <div class="col-xs-12 col-sm-8 col-md-8 property-list-list-info">
          <div class="col-xs-12 col-sm-6 col-md-6">
            <a href="#.">
