            ...
            <ul class="nav navbar-nav" data-in="fadeInDown" data-out="fadeOutUp">
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="index-6.html">Home V - 6</a></li>
  ...
  <div id="rev_full" class="rev_slider"  data-version="5.0">
    <ul>
      ...
      <li data-transition="fade">
        ...
        <div class="tp-caption tp-resizeme"               
          data-x="['center','center','center','center']" data-hoffset="['15','15','0','0']" 
          data-y="['330','290','230','230']" data-voffset="['0','0','0','0']"
          data-responsive_offset="on"
        ...
        <div class="tp-caption tp-resizeme"               
          data-x="['center','center','center','center']" data-hoffset="['15','15','0','0']" 
          data-y="['390','350','290','240']" data-voffset="['0','0','0','0']"
          data-responsive_offset="on"
          data-visibility="['on','on','on','on']"
          data-transform_idle="o:1;"
          data-transform_in="z:0;rX:0;rY:0;rZ:0;sX:0.9;sY:0.9;skX:0;skY:0;opacity:0;s:1500;e:Power3.easeInOut;" 
          ...
          <a href="https://themeforest.net/item/idea-homes-real-estate-template/18809246" class="white_border">Buy Now</a>
        </div>
      </li>
      <li data-transition="fade">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="line_2"></div>
        <div class="line_3"></div>
        <p class="bottom20">Mauris accumsan eros eget libero posuere vulputate. Etiam elit elit, elementum sed varius at, adipiscing
          <br>vitae est. Sed nec felis pellentesque, lacinia dui sed, ultricies sapien.
        </p>
      </div>
    </div>
