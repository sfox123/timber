...
<title>IDEA HOMES | SUBMIT PROPERTY</title>
              ...
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      <li class="active"><a href="submit-property.html">Creat New Property V - 1</a></li>
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.html">home</a> <span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="submit-property.html">Submit Property</a> </div>
  </div>
</div>
<!--PAGE TITLE --> 
    ...
    <div class="row">
      ...
      <div class="col-md-10 col-sm-12 col-xs-12">
        ...
        <div class="property-query-area">
          ...
          <div class="row">
            <div class="col-md-12">
              <h3 class="text-uppercase  bottom40">Add Your <span class="color_red">Property</span></h3>
            </div>
          </div>
          ...
          <form class="findus">
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="single-query">
                    <select class="selectpicker" data-live-search="true">
                      <option selected="" value="any">Transaction:</option>
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="single-query">
                  <input type="text" class="keyword-input" placeholder="Bedrooms">
                </div>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="single-query">
                  <input type="text" class="keyword-input" placeholder="Bathrooms">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="single-query">
                  <textarea type="" class="" placeholder="Description"></textarea>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="group-button-search"> <a data-toggle="collapse" href=".search-propertie-filters" class="more-filter"> <i class="fa fa-plus text-1 bg-color-yello" aria-hidden="true"></i> <i class="fa fa-minus text-2 hide bg-color-yello" aria-hidden="true"></i>
                  <div class="text-1">More Propertie Detail</div>
                  <div class="text-2 hide">Less Propertie Detail</div>
                  </a> </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="search-form-group white">
                  ...
                  <span>Washer and Dryer</span> </div>
              </div>
              <div class="col-md-6">
                <div class="search-form-group white">
                  <input type="checkbox" name="check-box" />
          ...
          <div class="row padding_t55">
          	...
          	<div class="col-md-12">
              <h3 class="text-uppercase  bottom40">Property <span class="color_red">Images:</span></h3>
            </div>
          ...
          <div class="col-md-12">
            <h3 class="text-uppercase  bottom40">Property Place <span class="color_red">On Map:</span></h3>
          </div>
          ...
          <div class="row">
              ...
              <div class="col-md-12 top30">
                <div class="query-submit-button">
                  <button type="submit" class="btn_fill black">Submit Poperty</button>
                </div>
              </div>
            </div>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12 text-center">
        <div class="get-tuch"><i class=" icon-icons142"></i>
          <ul>
            ...
            <li><a href="#.">
              <p class="p-font-15">info@ideahomes.com</p>
              </a></li>
          </ul>
        </div>
      </div>
