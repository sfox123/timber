...
<title>IDEA HOMES | GALLERY </title>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="gallery-3.html">Gallery V - 3</a></li>
...
<div class="page-title page-main-section parallaxie">
    <div class="container padding-bottom-top-120 text-uppercase text-center">
      <div class="main-title">
        ...
        <a href="gallery-3.html">Gallery Style - 3</a> </div>
    </div>
</div>
<!--===== #/PAGE TITLE =====-->
...
<section id="project" class="padding">
  ...
  <div id="nospace-filter" class="cbp-l-filters-alignCenter">
    <div data-filter="*" class="cbp-filter-item-active cbp-filter-item">Show All <div class="cbp-filter-counter"></div> </div>
    <div data-filter=".sale" class="cbp-filter-item">Sale <div class="cbp-filter-counter"></div> </div>
    <div data-filter=".rent" class="cbp-filter-item"> Rent <div class="cbp-filter-counter"></div> </div>
    <div data-filter=".latest" class="cbp-filter-item">Latest <div class="cbp-filter-counter"></div> </div>
  </div>

  <div id="nospace" class="cbp">
    <div class="cbp-item latest rent">
      <div class="image">
         <img src="images/nospace1.jpg" alt="">
         <div class="overlay">
            <a href="images/nospace1.jpg" class="fancybox centered" data-fancybox-group="gallery">
    ...
    <div class="cbp-item sale">
      <div class="image">
         <img src="images/nospace2.jpg" alt="">
         <div class="overlay">
            <a href="images/nospace2.jpg" class="fancybox centered" data-fancybox-group="gallery">
            <i class="icon-focus"></i>
          </a>
         </div>
      </div>
    ...
    <div class="cbp-item sale">
      <div class="image">
         <img src="images/nospace3.jpg" alt="">
         <div class="overlay">
            <a href="images/nospace3.jpg" class="fancybox centered" data-fancybox-group="gallery">
            <i class="icon-focus"></i>
          </a>
         </div>
      </div>
    ...
    <div class="cbp-item latest rent">
      <div class="image">
      <img src="images/nospace4.jpg" alt="">
         <div class="overlay">
            <a href="images/nospace4.jpg" class="fancybox centered" data-fancybox-group="gallery">
            <i class="icon-focus"></i>
          </a>
         </div>
      </div>
    ...
    <div class="cbp-item sale">
      <div class="image">
      <img src="images/nospace5.jpg" alt="">
         <div class="overlay">
            <a href="images/nospace5.jpg" class="fancybox centered" data-fancybox-group="gallery">
            <i class="icon-focus"></i>
          </a>
         </div>
      </div>
    ...
    <div class="cbp-item latest rent">
      <div class="image">
         <img src="images/nospace6.jpg" alt="">
         <div class="overlay">
            <a href="images/nospace6.jpg" class="fancybox centered" data-fancybox-group="gallery">
            <i class="icon-focus"></i>
          </a>
         </div>
      </div>
    ...
    <div class="cbp-item management sale">
      <div class="image">
      <img src="images/nospace7.jpg" alt="">
         <div class="overlay">
            <a href="images/nospace7.jpg" class="fancybox centered" data-fancybox-group="gallery">
            <i class="icon-focus"></i>
          </a>
         </div>
      </div>
    ...
    <div class="cbp-item services sale latest">
      <div class="image">
      <img src="images/nospace8.jpg" alt="">
         <div class="overlay">
            <a href="images/nospace8.jpg" class="fancybox centered" data-fancybox-group="gallery">
            <i class="icon-focus"></i>
          </a>
         </div>
      </div>
    ...
    <div class="cbp-item services sale latest">
      <div class="image">
      <img src="images/nospace9.jpg" alt="">
         <div class="overlay">
            <a href="images/nospace9.jpg" class="fancybox centered" data-fancybox-group="gallery">
            <i class="icon-focus"></i>
          </a>
         </div>
      </div>
