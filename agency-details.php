...
<title>IDEA HOMES | Agencies Listing </title>
                ...
                <ul class="dropdown-menu">
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="agency-details.html">Agency Deatil</a></li>
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.html">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="#.">Agency Details</a> 
    </div>
  </div>
</div>
<!--===== #/PAGE TITLE =====-->
...
<!--===== Agency Details =====-->
<section id="news-section-1" class="padding agency-listing bg_light">
  <div class="container">
