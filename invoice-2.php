...
<title>IDEA HOMES | INVOICE </title>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="invoice-2.html">Create Invoice V - 2</a></li>
                    </ul>
                  </li>
                  <li class="dropdown">
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.html">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="#.">Invoice</a> 
    </div>
  </div>
</div>
<!--===== #/PAGE TITLE =====-->
...
<!--===== Invoice =====-->
<section id="invoice" class="padding bg_light">
  <div class="container">
     <div class="invoice-header">INVOICE</div>

        <div id="identity">

            <textarea id="address">Chris Coyier 123 Appleseed Street Appleville, WI 53719 Phone: (555) 555-5555
            </textarea>
            ...
            <div id="logo">
                ...
                <img id="image" src="images/logo_center_2.png" alt="logo" />
            </div>
        ...
        <div id="customer">
            ...
            <table id="meta">
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="date">Jan 18, 2018</textarea>
                    </td>
                </tr>
                <tr>
        ...
        <table id="items">
            ...
            <tr class="item-row">
                <td class="item-name">
                    <div class="delete-wpr">
                        <textarea>Web Updates</textarea><a class="delete" href="javascript:;" title="Remove row">X</a></div>
                </td>
            ...
            <tr class="item-row">
                <td class="item-name">
                    <div class="delete-wpr">
                        <textarea>SSL Renewals</textarea><a class="delete" href="javascript:;" title="Remove row">X</a></div>
                </td>
...
<div class="bg_light padding_bottom">
  <div class="container">
    <div class="row">

      <div class="col-md-3 col-sm-3 col-xs-12 text-center">
        <div class="invoice-sending">
          <a href="#">
