                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="gallery-2.html">Gallery V - 2</a></li>
...
<section id="project" class="padding">
  <div class="container">
    <div id="project-filter" class="cbp-l-filters-alignCenter">
      ...
      <div data-filter=".sale" class="cbp-filter-item">
        Sale 
        <div class="cbp-filter-counter"></div>
      </div>
      <div data-filter=".rent" class="cbp-filter-item">
        Rent 
        <div class="cbp-filter-counter"></div>
      </div>
      <div data-filter=".latest" class="cbp-filter-item">
        Latest 
        <div class="cbp-filter-counter"></div>
      </div>
    </div>
