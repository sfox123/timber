...
<title>IDEA HOMES | PACKAGES </title>
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.html">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="#."> Packages</a> 
    </div>
  </div>
</div>
<!--===== #/PAGE TITLE =====-->
...
<section class="bg_light padding">
    <div id="pricePlans">
        ...
        <div class="row margin-b60">
          <div class="col-sm-1 col-md-2"></div>
          <div class="col-xs-12 col-sm-10 col-md-8 text-center">
            <h2 class="text-uppercase">Our <span class="color_red">Packages</span></h2>
