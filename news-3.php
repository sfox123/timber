                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="news-3.html">Our Blog V - 3</a></li>
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.html">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="#."> News</a> 
    </div>
  </div>
</div>
<!--===== #/PAGE TITLE =====-->
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                ...
                <div class="latest_page_box">
                    <span class="news_date">
                      <i class="fa fa-calendar" aria-hidden="true"></i> April 19, 2018
                    </span>
                    <div class="news_image">

                        <img src="images/nav-slider1.jpg" alt="image">
                        <div class="price">
                    ...
                    <div class="news_padding">
                        ...
                        <a class="btn_fill" href="#">Read More</a>
                    </div>
                </div>

                <div class="latest_page_box">
                    <span class="news_date"><i class="fa fa-calendar" aria-hidden="true"></i> April 19, 2018</span>
                    <div class="news_image">

                        <img src="images/nav-slider2.jpg" alt="image">
                        <div class="price">
                            <span class="tag_red">26</span>
                            <span class="tag_white">MAR</span>
                        </div>
                    ...
                    <div class="news_padding">
                        ...
                        <p class="pull-right"><a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> No Comments</a></p>
                        <h3>Our Outstanding Services</h3>
                        <p class="m-b-30">Benenatis mauris Vestibulum ante ipsum primis in industry, logistics, finance, business orci ultrices venenatis mauris. It is a long established fact that a reader will be distracted.</p>
                        <a class="btn_fill" href="#">Read More</a>
                    </div>
                </div>
                ...
                <div class="latest_page_box">
                    ...
                    <div class="news_image">
                        ...
                        <img src="images/nav-slider3.jpg" alt="image">
                        <div class="price">
                            <span class="tag_red">26</span>
                            <span class="tag_white">MAR</span>
                        </div>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                ...
                <div class="latest_page_box">
                    ...
                    <div id="about_slider" class="owl-carousel">
                        <div class="item">
                            <div class="news_image">
                                <figure class="effect-layla"> <img src="images/nav-slider1.jpg" alt="image">
                        ...
                        <div class="item">
                            <div class="news_image">
                                <figure class="effect-layla"> <img src="images/nav-slider2.jpg" alt="image">
                                    <figcaption> </figcaption>
                        ...
                        <div class="item">
                            <div class="news_image">
                                <figure class="effect-layla"> <img src="images/nav-slider3.jpg" alt="image">
                                    <figcaption> </figcaption>
