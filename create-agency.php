...
<title>IDEA HOMES | CREATE AGENCY</title>
                ...
                <ul class="dropdown-menu">
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="create-agency.html">Creat New Agency</a></li>
                    </ul>
                  </li>
                  <li class="dropdown">
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.html">home</a> <span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="submit-property.html">Create Agency</a> </div>
  </div>
</div>
<!--PAGE TITLE --> 
                ...
                <div class="profile-login-bg">
                    ...
                    <div class="row bottom40">
                      <div class="col-md-12">
                        ...
                        <div id="address-text"><i class="fa fa-map-marker"></i> <input type="text" class="form-control" placholder="Drag the pin to the location on the map" name="text"></div>
                        <div id="map"></div>
                      </div>
                    </div>
