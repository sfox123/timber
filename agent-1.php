              ...
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      <li class="active"><a href="agent-1.html">Our Agents V - 1</a></li>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4 col-xs-12 text-center">
          ...
          <div class="img">
            <div class="gri">
              <figure class="effect-layla">
                <img src="images/agen-s-1.jpg" alt="">
        ...
        <div class="agent-text">
          ...
          <a href="properties-listing.html" class="link_arrow">Read More</a>
        </div>
      </div>
      <div class="col-md-4 col-sm-4 col-xs-12 text-center">
        <div class="effects clearfix">
          <div class="img">
            <div class="gri">
              <figure class="effect-layla">
                <img src="images/agen-s-2.jpg" alt="">
                <figcaption> </figcaption>
              </figure>
            </div>
          </div>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12 text-center">
        <div class="effects clearfix">
          <div class="img">
            <div class="gri">
              <figure class="effect-layla">
                <img src="images/agen-s-3.jpg" alt="">
                <figcaption> </figcaption>
              </figure>
            </div>
          </div>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12 text-center">
        <div class="effects clearfix">
          <div class="img">
            <div class="gri">
              <figure class="effect-layla">
                <img src="images/agen-s-4.jpg" alt="">
                <figcaption> </figcaption>
              </figure>
            </div>
          </div>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12 text-center">
        <div class="effects clearfix">
          <div class="img">
            <div class="gri">
              <figure class="effect-layla">
                <img src="images/agen-s-5.jpg" alt="">
                <figcaption> </figcaption>
              </figure>
            </div>
          </div>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12 text-center">
        <div class="effects clearfix">
          <div class="img">
            <div class="gri">
              <figure class="effect-layla">
                <img src="images/agen-s-6.jpg" alt="">
                <figcaption> </figcaption>
              </figure>
            </div>
          </div>
