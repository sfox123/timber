                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="error-500.html">Error Page 500</a></li>
                    </ul>
                  </li>
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.html">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="#.">Error 500</a> 
    </div>
  </div>
</div>
<!--===== #/PAGE TITLE =====-->
  ...
  <div class="container">
    <div class="row text-center">
      <div class="error-image col-sm-12">
        <img src="images/500.png" alt="image" class="bottom30" />
      </div>
