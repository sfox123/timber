                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="news-2.html">Our Blog V - 2</a></li>
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="news-2.html">News Style - 2</a> 
    </div>
  </div>
</div>
<!-- PAGE TITLE -->
    ...
    <div class="row">
      <div class="col-md-8 col-sm-7">
        <div class="col-md-6 margin_bottom">
          <div class="image"><img src="images/news-1.jpg" alt="image"></div>
          <div class="sim-lar-text">
            ...
            <p> power nonummy nibh tempor cum soluta nobis eleifend consectetuer adipiscing elit, sed diam consectetuer adipiscing elit, sed diam power power...</p>
            <a href="news_details.html" class="link_arrow top20">Read More</a>
          </div>
        </div>
        <div class="col-md-6 margin_bottom">
          <div class="image"><img src="images/news-2.jpg" alt="image"></div>
          <div class="sim-lar-text">
            <h3>Historic Town House</h3>
            <p class="bottom10"><span>By:</span> Admin <span>|</span> <span>Date:</span> Feb 22, 2017</p>
            <p> power nonummy nibh tempor cum soluta nobis eleifend consectetuer adipiscing elit, sed diam consectetuer adipiscing elit, sed diam power power...</p>
        ...
        <div class="col-md-6 margin_bottom">
          <div class="image"><img src="images/news-3.jpg" alt="image"></div>
          <div class="sim-lar-text">
            <h3>Historic Town House</h3>
            <p class="bottom10"><span>By:</span> Admin <span>|</span> <span>Date:</span> Feb 22, 2017</p>
            <p> power nonummy nibh tempor cum soluta nobis eleifend consectetuer adipiscing elit, sed diam consectetuer adipiscing elit, sed diam power power...</p>
        ...
        <div class="col-md-6 margin_bottom">
          <div class="image"><img src="images/news-4.jpg" alt="image"></div>
          <div class="sim-lar-text">
            <h3>Historic Town House</h3>
            <p  class="bottom10"><span>By:</span> Admin <span>|</span> <span>Date:</span> Feb 22, 2017</p>
            <p> power nonummy nibh tempor cum soluta nobis eleifend consectetuer adipiscing elit, sed diam consectetuer adipiscing elit, sed diam power power...</p>
        ...
        <div class="col-md-6 margin_bottom">
          <div class="image"><img src="images/news-5.jpg" alt="image"></div>
          <div class="sim-lar-text">
            <h3>Historic Town House</h3>
            <p class="bottom10"><span>By:</span> Admin <span>|</span> <span>Date:</span> Feb 22, 2017</p>
            <p> power nonummy nibh tempor cum soluta nobis eleifend consectetuer adipiscing elit, sed diam consectetuer adipiscing elit, sed diam power power...</p>
      ...
      <div class="col-md-4 col-sm-5">
        ...
        <div class="blog_info blog-thumbnail">
          ...
          <ul class="archieves clearfix">
            ...
            <li>
              <div class="col-md-4 col-sm-2 padding_none">
                <div class="blogimage_thumbnail">
                  <img src="images/f-p-2.png" alt="blog1 image">
                </div>
              </div>
              <div class="col-md-8 col-sm-10">
                <div class="blogimagedescription">
            ...
            <li>
              <div class="col-md-4 col-sm-2 padding_none">
                <div class="blogimage_thumbnail">
                  <img src="images/f-p-3.png" alt="blog1 image">
                </div>
              </div>
              <div class="col-md-8 col-sm-10">
                <div class="blogimagedescription">
        ...
        <div class="row">
          <div class="col-md-12 top40">
            <h3 class="text-uppercase  bottom40">Latest <span class="color_red">Properties</span></h3>
          </div>
          <div class="col-md-12">
