...
<title>IDEA HOMES | LISTING</title>
                ...
                <ul class="dropdown-menu">
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="listing-2.html">Property Listing V - 2</a></li>
                    </ul>
                  </li>
                  <li class="dropdown">
...
<div class="page-title page-main-section">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.html">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="listing-2.html">Listing Properties</a> 
    </div>
  </div>
</div>
<!-- PAGE TITLE -->
...
<section class="property-query-area property-page-bg padding">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="group-button-search"><a data-toggle="collapse" href=".search-propertie-filters" class="more-filter"><i class="fa fa-plus text-1" aria-hidden="true"></i><i class="fa fa-minus text-2 hide" aria-hidden="true"></i>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="property_item heading_space">
          <div class="property_head default_clr text-center">
            <a href="#."><h3 class="captlize p-white ">The Helux villa</h3></a>
              <img src="images/listing.png" alt="listin" class="start_tag">
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="property_item heading_space">
          <div class="property_head text-center">
            <a href="#."><h3 class="captlize">The Helux villa</h3></a>
