...
<title>IDEA HOMES | LOAN CALCULATOR</title>
            ...
            <ul class="nav navbar-nav" data-in="fadeInDown" data-out="fadeOutUp">
              ...
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="auto-loan-calculator.html">Loan Calculate</a></li>
                </ul>
              </li>
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.html">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="#.">Loan Calculator</a> </div>
  </div>
</div>
<!--===== #/PAGE TITLE =====--> 
    ...
    <div class="row text-center">
      ...
      <div class="col-md-6 col-sm-8 col-xs-12">
        ...
        <div class="row  p-b-30  p-t-30">
         ...
         <div class="row">
          <div class="col-md-12">
            <a href="auto-loan-calculator.html" class="reset">Reset</a>
          </div>
         </div>
