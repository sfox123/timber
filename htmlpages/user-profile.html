...
<title>IDEA HOMES | USER PROFILE </title>
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.html">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="profile.html"> User Profile</a> </div>
  </div>
</div>
<!--===== #/PAGE TITLE =====-->
                ...
                <form action="#">
                  ...
                  <div class="col-md-12 clearfix">
                    ...
                    <label>Email Adress:</label>
                      <input type="text" placeholder="bohdan@ideahomes.com" class="keyword-input">
                    </div>
                  </div>
