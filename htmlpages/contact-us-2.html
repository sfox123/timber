...
<title>IDEA HOMES | CONTACT US </title>
            ...
            <ul class="nav navbar-nav" data-in="fadeInDown" data-out="fadeOutUp">
              ...
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="contact-us-2.html">Contact Us V - 2</a></li>
...
<div class="page-title page-main-section parallaxie" style="background-image: url(images/titlebg-1.jpg);">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index-1.html">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="contact-us.html">Contact us</a> 
    </div>
  </div>
</div>
<!--===== #/PAGE TITLE =====-->
                ...
                <div class="contact-bg">
                    ...
                    <form class="contact-form">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group single-query"">
                                    <input type="text" name="name" class="keyword-input" placeholder="Web Site">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group single-query"">
                                    <img src="images/contact.jpg" class="img-responsive" alt="image">
                                </div>
                            </div>
