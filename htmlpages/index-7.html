      ...
      <div class="header_set">
        <div class="col-md-12 text-right">
          <div class="get-tuch text-left">
            ...
            <ul>
              <li><h4>+1(123) 456 567</h4></li>
              <li><a href="#." ><p class="p_14">support@ideahomes.com</p></a></li>
            </ul>
          </div>
          <div class="get-tuch text-left">
  ...
  <div class="container padding-bottom-top-120">
    <div class="row padding_bottom">
      <div class="col-sm-12 padding_top">
        <h2 class="text-capitalize text-center top30 color_white"> Discover your places at <span class="color_red">idea homes</span> </h2>
