        ...
        <div class="col-md-8 col-sm-8 col-xs-12 text-right">
          <div class="header-top-links">
            <ul>
              ...
              <li><a href="login.html" class="header-login"><i class="icon-icons179"></i>Login / Register</a></li>
            </ul>
          </div>
        </div>
      </div>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="faq-3.html">FAQ's V - 3</a></li>
                    </ul>
                  </li>
                  <li class="dropdown">
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index.html">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="faq.html">Ask Your Question</a> </div>
  </div>
</div>
<!--===== #/PAGE TITLE =====-->
	...
	<div class="container">
    	<div class="row">
        	...
        	<div class="col-md-6 col-sm-6 col-xs-12">
            	...
            	<div class="faq-text">
                    <h5>Q: Suspendisse eleifend massa commodo porta lacus bibendum?</h5>
                    ...
                    <p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Duis et metus in libero sollicitudin venenatis eu sed enim. Nam felis lorem, suscipit ac nisl ac, iaculis dapibus tellus. Cras ante justo, aliquet quis placerat nec, molestie id turpis.</p>
            	</div>
                
                <div class="faq-text">
                    <h5>Q:  sodales tellus non, gravida turpis?</h5>
                    
                    <p >Bibendum purus sit amet, vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus.</p>
                    
                    <p>Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
            	</div>
                
                <div class="faq-text">
                    <h5>Q:  massa commodo porta lacus bibendum?</h5>
                    
                    <p >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras et dui vestibulum, bibendum purus sit amet, vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus. Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
            	</div>
                
                <div class="faq-text">
                    <h5>Q:  massa commodo porta lacus bibendum?</h5>
                    
                    <p >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras et dui vestibulum, bibendum purus sit amet, vulputate mauris.</p>
                    
                    <p>Ut adipiscing gravida tincidunt.</p>
            	</div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            	...
            	<div class="faq-text">
                    <h5>Q: Aliquam eget quam iaculis.</h5>
                    
                    <p>Bibendum purus sit amet, vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus. Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
            	</div>
                ...
                <div class="faq-text">
                    <h5>Q:  Suspendisse eleifend tellus non, gravida turpis.</h5>
                    
                    <p>Bibendum purus sit amet, vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus. Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
                     <p > <p >Bibendum purus sit amet, vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus. Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
            	</div>
                ...
                <div class="faq-text">
                    ...
                    <p >Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
                    <p>vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus. Phasellus mollis imperdiet placerat. Sed ac turpis nisl. Mauris at ante mauris. </p>
            	</div>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12 text-center">
        <div class="get-tuch"><i class="icon-icons74"></i>
          <ul>
            ...
            <li>
              <p class="p-font-15">Idea Homes Melbourne, australia</p>
            </li>
          </ul>
        </div>
        <div class="get-tech-line"><img src="images/get-tuch-line.png" alt="line"/></div>
