...
<title>IDEA HOMES | SHOWCASE </title>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="row">
          <div class="col-md-12">
            <div id="property-d-1" class="owl-carousel">
              <div class="item"><img src="images/property-d-1-1.jpg" alt="image" /></div>
              <div class="item"><img src="images/property-d-1-1.jpg" alt="image" /></div>
              <div class="item"><img src="images/property-d-1-1.jpg" alt="image" /></div>
              <div class="item"><img src="images/property-d-1-1.jpg" alt="image" /></div>
              <div class="item"><img src="images/property-d-1-1.jpg" alt="image" /></div>
            ...
            <div id="property-d-1-2" class="owl-carousel">
              <div class="item"><img src="images/property-d-s-1-1.jpg" alt="image" /></div>
              <div class="item"><img src="images/property-d-s-1-2.jpg" alt="image" /></div>
              <div class="item"><img src="images/property-d-s-1-3.jpg" alt="image" /></div>
              <div class="item"><img src="images/property-d-s-1-4.jpg" alt="image" /></div>
              <div class="item"><img src="images/property-d-s-1-5.jpg" alt="image" /></div>
              <div class="item"><img src="images/property-d-s-1-1.jpg" alt="image" /></div>
              <div class="item"><img src="images/property-d-s-1-2.jpg" alt="image" /></div>
            </div>
          </div>
            ...
            <div class="property-tab">
              ...
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="description">
                  ...
                  <div class="property_meta margin-t-2 bg-black bottom40">
                  ...
                  <button class="btn_fill" type="submit">Read More</button>
                </div>
                ...
                <div role="tabpanel" class="tab-pane" id="tab_contact">
                  <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <div class="agent-p-img"> <img src="images/agent-p-1.jpg" class="img-responsive" alt="image" /> </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <div class="agent-p-contact">
                        <div class="our-agent-box">
                          <h3>Kristen Kononets</h3>
                    ...
                    <div class="col-md-12">
                      <div class="social-networks top40">
                        <div class="social-icons-2">
                          <span class="share-it">Social Media</span>
        ...
        <div class="row">
          <div class="col-xs-12 bottom40 top40">
            <h2 class="text-uppercase">Video <span class="color_red">Presentation</span></h2>
...
<section id="agent-p-2" class="bg_light property-details padding">
  <div class="container">
    <div class="row">
      <div class="col-xs-12">
        <h2 class="text-uppercase">Similar <span class="color_red">PROPERTY</span></h2>
        <p class="heading_space">We have Properties in these Areas View a list of Featured Properties.</p>
        <div class="line_1"></div>
        <div class="line_2"></div>
        <div class="line_3"></div>
      ...
      <div class="col-md-12">
        <div id="property-1-slider" class="owl-carousel">
          <div class="item">
            <div class="property_item heading_space">
              <div class="image">
                <a href="#."><img class="img-responsive" alt="listin" src="images/b-d-property.jpg" style="top: 0px;"></a>
                <div class="feature"><span class="tag">Featured</span></div>
                <div class="feature"><span class="tag-2">For Sale</span></div>
                <div class="price clearfix"><span class="tag pull-right">$8,600 Per Month</span></div>
              </div>
              <div class="property_head">
                <a href="#.">
                  <h3 class="captlize">House in New York City</h3>
                  <p class="p-font-15">Towson London, MR 21501</p>
                </a>
              </div>
              <div class="proerty_content">
                <div class="property_meta"> <span><i class="icon-select-an-objecto-tool"></i>4800 sq ft</span> <span><i class=" icon-bed"></i>2 Bed Rooms</span> <span><i class="icon-safety-shower"></i>1 Bathroom</span> </div>
                <div class="property_meta padding-b-30"> <span><i class="icon-old-television"></i>TV Lounge</span> <span><i class="icon-garage"></i>1 Garage</span> <span></span> </div>
          ...
          <div class="item">
            <div class="property_item heading_space">
              <div class="image">
                <a href="#."><img class="img-responsive" alt="listin" src="images/b-d-property-2.jpg" style="top: 0px;"></a>
                <div class="feature"><span class="tag">Featured</span></div>
                <div class="feature"><span class="tag-2">For Sale</span></div>
                <div class="price clearfix"><span class="tag pull-right">$8,600 Per Month</span></div>
              </div>
