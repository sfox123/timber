                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="agent-profile-2.html">Agents Profile V - 2</a></li>
                    </ul>
                  </li>
                  <li class="dropdown">
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="index_1.html">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>
      <a href="agent_profile_2.html">Agent Profile - 2</a> 
    </div>
  </div>
</div>
<!--PAGE TITLE -->
...
<!--===== AGENT PROFILE - 2 =====-->
<section id="agent-p-2" class="padding">
  <div class="container">
    <div class="row">
      <div class="col-md-5 col-sm-5 col-xs-12">
        <div class="agent-p-img">
          <img src="images/agent-p-1.jpg" class="img-responsive" alt="image" />
        </div>
      </div>
      <div class="col-md-7 col-sm-7 col-xs-12">
        <div class="agent-p-contact">
          <div class="our-agent-box">
            <h3>Charli Robert</h3>
            <p class="p-font-15 margin-t-20">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh tempor cum soluta nobis consectetuer adipiscing eleifend option congue nihil imperdiet doming  consectetuer adipiscing eleifend option congue nihil imperdiet doming…</p>
          </div>
          ...
          <form class="findus">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <a href="#" class="btn_fill">Search</a>
              </div>
            </div>
          </form>
        </div>
...
<!--===== AGENT PROPERTY =====-->
<section id="agent-details" class="bg_light padding">
  <div class="container">
    <div class="row">
      <div class="col-md-4 col-sm-5 col-xs-4 padding_top">
        <h3 class="text-uppercase  bottom40">Recent <span class="color_red">Properties</span></h3>
        <div class="media">
      ...
      <div class="col-md-4 col-sm-4 col-xs-12 text-center">
        <div class="get-tuch"><i class=" icon-icons142"></i>
          <ul>
            ...
            <li>
              <p class="p-font-15">info@Idea-Homes.com</p>
            </li>
          </ul>
        </div>
      </div>
