...
<title>IDEA HOMES | FAVOURITE PROPERTIES</title>
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="favorite-properties.html">Favorite Properties</a> 
    </div>
  </div>
</div>
<!-- PAGE TITLE -->
...
<!-- FAVORITE PROPERTY -->
<section id="favorite-peperty" class="favour-pro padding bg_light">
  <div class="container">
    <div class="row">
      <div class="col-xs-12 bottom40">
        <h2 class="text-uppercase">My favourite<span class="color_red"> Properties</span></h2>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12 text-center">
        <div class="get-tuch"><i class="icon-icons74"></i>
          <ul>
            ...
            <li>
              <p class="p-font-15">IdeaHomes, australia</p>
            </li>
          </ul>
        </div>
        <div class="get-tech-line"><img src="images/get-tuch-line.png" alt="line"/></div>
