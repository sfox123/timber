                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="property-details-2.html">Property Details V - 2</a></li>
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="property-details-2.html">Property Details - 2</a> 
    </div>
  </div>
</div>
<!--===== #/PAGE TITLE =====--> 
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <p class="">45 Regent Street, London, UK</p>
      </div>
    </div>
    <div class="row">
        ...
        <div id="agent-2-slider" class="owl-carousel">
          <div class="item">
            <div class="property_item heading_space">
              <div class="image">
                <a href="#."><img src="images/property-d-1-2.jpg" alt="listin" class="img-responsive"></a>
