                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="gallery-4.html">Gallery V - 4</a></li>
                    </ul>
                  </li>
                  <li class="dropdown">
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="gallery-4.html">Gallery Style - 4</a> 
    </div>
  </div>
</div>
<!--===== #/PAGE TITLE =====-->
    ...
    <div id="projects" class="cbp">
      ...
      <div class="cbp-item services sale latest">
        ...
        <img src="images/project9.jpg" alt="">
           <div class="overlay">
              <a href="images/project10.jpg" class="fancybox centered" data-fancybox-group="gallery">
              <i class="icon-focus"></i>
            </a>
           </div>
        </div>
      ...
      <div class="cbp-item services sale latest">
        ...
        <img src="images/project10.jpg" alt="">
           <div class="overlay">
              <a href="images/project11.jpg" class="fancybox centered" data-fancybox-group="gallery">
              <i class="icon-focus"></i>
            </a>
           </div>
        </div>
