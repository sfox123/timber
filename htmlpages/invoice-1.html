              ...
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      <li class="active"><a href="invoice-1.html">Create Invoice V - 1</a></li>
...
<!--===== Invoice =====-->
<section id="invoice2" class="padding bg_light">
    <div class="container">
        <div class="row">

            <div class="col-md-9 col-sm-9 col-xs-12">
                <div class="invoice2">
                    <header id="invoice2-header">
                        <h1>Invoice</h1>
                        <address contenteditable>
                          <label>Address</label>
                          <p>Your</p>
                          <p>address is here<br>city & code</p>
                          <p>(800) 555-1234</p>
                        </address>
                        <span><img alt="" src="images/logo_center_2.png"><input type="file" accept="image/*"></span>
                    </header>
                    ...
                    <article class="invoice-body">
                        ...
                        <table class="inventory">
                            ...
                            <tbody>
                                <tr>
                                    <td><a class="cut">-</a><span contenteditable>Front End Work</span></td>
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <div class="invoice-sending text-center">
                  <a href="#">
