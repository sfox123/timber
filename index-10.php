...
<div class="sidebar_menu">
  <nav class="pushmenu pushmenu-left">
    <a class="push-logo" href="index.html"><img src="images/logo-white.png" alt="logo"></a>
    <ul class="push_nav bottom20">
      <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="index-10.html">Home V - 10</a></li>
  ...
  <div id="rev_full" class="rev_slider"  data-version="5.0">
    <ul>
      ...
      <li data-transition="crossfade">
        <img src="images/banner-5.jpg"  alt="" data-bgposition="center center" data-bgfit="cover" class="rev-slidebg">
        <div class="tp-caption tp-resizeme"               
          data-x="['center','center','center','center']" data-hoffset="['15','15','0','0']" 
          data-y="['290','230','170','170']" data-voffset="['0','0','0','0']"
          data-responsive_offset="on"
      ...
      <li data-transition="fadefromleft">
        <img src="images/banner-6.jpg"  alt="" data-bgposition="center center" data-bgfit="cover" class="rev-slidebg">
        <div class="tp-caption tp-resizeme"               
          data-x="['center','center','center','center']" data-hoffset="['15','15','0','0']" 
          data-y="['290','230','170','170']" data-voffset="['0','0','0','0']"
          data-responsive_offset="on"
  ...
  <div class="container">
    ...
    <div class="col-sm-1 col-md-2"></div>
      <div class="col-xs-12 col-sm-10 col-md-8 text-center">
        <h2 class="text-uppercase">Welcome to <span class="color_red">idea homes</span></h2>
    ...
    <div class="row">
      <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="estimate_image">
          <img src="images/estimate.png" alt="image" class="img-responsive">
        </div>
      </div>
      <div class="col-md-6 col-sm-6 col-xs-12">
  ...
  <div class="container">
    ...
    <div id="our-agent-slider" class="owl-carousel">
      <div class="item">
        <div class="single-effect">
          <figure class="ageent_overlay">
            <a href="#."><img src="images/agent-1.jpg" alt="img"></a>
            <figcaption class="view-caption">
              <a href=".team"><i class="icon-focus"></i></a>
            </figcaption>
          </figure>
        </div>
      ...
      <div class="item">
        <div class="single-effect">
          <figure class="ageent_overlay">
            <a href="#."><img src="images/agent-2.jpg" alt="img"></a>
            <figcaption class="view-caption">
              <a href=".team"><i class="icon-focus"></i></a>
            </figcaption>
          </figure>
      ...
      <div class="item">
        <div class="single-effect">
          <figure class="ageent_overlay">
            <a href="#."><img src="images/agen-s-3-1.jpg" alt="img"></a>
            <figcaption class="view-caption">
              <a href=".team"><i class="icon-focus"></i></a>
            </figcaption>
          </figure>
      ...
      <div class="item">
        <div class="single-effect">
          <figure class="ageent_overlay">
            <a href="#."><img src="images/agen-s-3-2.jpg" alt="img"></a>
            <figcaption class="view-caption">
              <a href=".team"><i class="icon-focus"></i></a>
            </figcaption>
          </figure>
      ...
      <div class="item">
        <div class="single-effect">
          <figure class="ageent_overlay">
            <a href="#."><img src="images/agen-s-3-3.jpg" alt="img"></a>
            <figcaption class="view-caption">
              <a href=".team"><i class="icon-focus"></i></a>
            </figcaption>
          </figure>
      ...
      <div class="item">
        <div class="single-effect">
          <figure class="ageent_overlay">
            <a href="#."><img src="images/agen-s-3-4.jpg" alt="img"></a>
            <figcaption class="view-caption">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="sim-lar-p">
          <div class="image"><img src="images/news1.jpg" alt="image"></div>
          <div class="sim-lar-text">
            ...
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam power...</p>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="sim-lar-p">
          <div class="image"><img src="images/news2.jpg" alt="image"></div>
          <div class="sim-lar-text">
            <h3>Historic Town House</h3>
            <p class="bottom10"><span>By:</span> Admin <span>|</span> <span>Date:</span> Feb 22, 2017</p>
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam power...</p>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="sim-lar-p">
          <div class="image"><img src="images/news3.jpg" alt="image"></div>
          <div class="sim-lar-text">
            <h3>Historic Town House</h3>
            <p class="bottom10"><span>By:</span> Admin <span>|</span> <span>Date:</span> Feb 22, 2017</p>
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam power...</p>
          ...
          <div class="row">
            ...
            <div class="col-md-7">
              <div class="pop_text">
                <h3>Brian Mady</h3>
                <p>sales executive</p>
                <p class="top30 bottom30">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Benenatis mauris. Vestibulum ante ipsum primis in industry, logistics, finance, business orci ultrices venenatis mauris.</p>
              </div>
              <div class="lebal">
                <p>Strategy</p>
              ...
              <div class="progress">
                <div class="progress-bar" role="progressbar" aria-valuenow="2" aria-valuemin="0" aria-valuemax="100" style="min-width:36em; width: 100%;">
                </div>
              </div>
              <div class="lebal">
                <p>Design</p>
              ...
              <div class="progress">
                <div class="progress-bar" role="progressbar" aria-valuenow="2" aria-valuemin="0" aria-valuemax="100" style="min-width:34em; width: 70%;">
                </div>
              </div>
              <ul class="socials">
                <li><a href="#."><i class="fa fa-facebook"></i></a></li>
