              ...
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                      <li class="active"><a href="agent-profile-1.html">Agents Profile V - 1</a></li>
...
<div class="page-title page-main-section parallaxie">
  <div class="container padding-bottom-top-120 text-uppercase text-center">
    <div class="main-title">
      ...
      <a href="agent_profile_1.html">Agent Profile - 1</a> </div>
  </div>
</div>
<!--===== #/PAGE TITLE =====-->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-5">
          <p class="font-11 text-black-777 m-0 copy-right">Copyright; 2016 <a href="#"><span class="color_red">IDEA HOMES</span></a>. All Rights Reserved</p>
        </div>
